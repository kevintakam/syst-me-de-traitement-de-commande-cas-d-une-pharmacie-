...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default" >
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                ...
                <li class="menu-item-has-children dropdown ">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-archive"></i><a href="#">Mon Compte</a></li>     
                        </ul>
                    </li>
                        ...
                        <div class="dropdown for-message">
                            <button class="btn btn-secondary dropdown-toggle" type="button"
                             ...
                             <div class="dropdown-menu" aria-labelledby="message" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 36px, 0px); top: 0px; left: 0px; will-change: transform;">
                                ...
                                <span class="photo media-left"><img alt="avatar"><i class="fa fa-user fa-2x"></i></span>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="entete.php"><i class="fa fa-user"></i> Notifications <span class="count"><?php echo $e->nombre_commande();?></span></a>
    ...
    <div class="modal-content">
      ...
      <div class="row" style="background-color:#18d26e; margin-left:1px;color:white;font-family:lucida;"><h3>Mon Compte</h3></div>
        
        <div class="col-sm-12" style="margin-top:20px;margin-left:300px; font-family:lucida;">
        ...
        <aside class="profile-nav alt">
            <section class="card">
                <div class="card-header user-header alt bg-dark">
                    <div class="media">
                        <a href="#">
                                            <img class="" style="width:85px; height:85px;" alt="" src="../images/fr.png">
                                        </a>
                        <div class="media-body">
                            <h2 class="text-light display-6"><?php echo ' '. $_SESSION['login'];?></h2>
                            <p>Gestionnaire De commande</p>
                        </div>
                    </div>
                </div>
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <a href="#"> <i class="fa fa-envelope-o"></i> Mail Inbox <span class="badge badge-primary pull-right">0</span></a>
                    </li>
                    <li class="list-group-item">
                        <a href="#"> <i class="fa fa-tasks"></i> Recent Activity <span class="badge badge-danger pull-right"><?php echo $e->nombre_commande_traite();?></span></a>
                    </li>
                    <li class="list-group-item">
                        <a href="entete.php"> <i class="fa fa-bell-o"></i> Notification <span class="badge badge-success pull-right"><?php echo $e->nombre_commande();?></span></a>
                    </li>
                    <li class="list-group-item">
                        <a href="#"> <i class="fa fa-comments-o"></i> Message <span class="badge badge-warning pull-right r-activity">0</span></a>
                    </li>
                    <li class="list-group-item">
                        <a data-toggle=modal data-dismiss="#staticModalLabel" href="#staticModalLabel"> <i class="fa fa-cog"></i> Deconnecter</a>
                    </li>
                </ul>
