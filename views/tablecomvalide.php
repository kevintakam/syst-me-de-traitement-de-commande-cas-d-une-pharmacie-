...
<body>
      ...
      <div class="card">
                            <div class="card-header">
                                <strong class="card-title" id="test">Toutes les Commandes rejetees</strong>
                            </div>
                            <div class="card-body">
                                 <div class="row"><div class="col-sm-12"><table id="bootstrap-data-table-export" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="bootstrap-data-table-export_info">
                                    ...
                                    <tbody>
                                         <?php
                                              ...
                                              ?> 
                                                  <tr> 
                                                  <?php if($r->getCommandes()[$i]->getStatus()=="validee"){?>         
                                                  ...
                                                  <td class="text-success"> <?php echo $r->getCommandes()[$i]->getStatus(); ?></td>
                                                  <td> R.A.S</td>
